...
//*************************************************************************************************************************************************//
BOOLEAN state_air_conditioning_on                              = FALSE;
//*************************************************************************************************************************************************//
//*******************************************************************SETTING***********************************************************************//
//*************************************************************************************************************************************************//
VOID Setting(){
...
//*************************************************************************************************************************************************//
   IF(data_receive == DATA_AIR_CONDITIONING_ON){
      state_air_conditioning_on = TRUE;
      counter_valve_driver = 0;
      DELAY_MS(20);
      Data_Sender(DATA_CONFIRM_AIR_CONDITIONING_ON);
      data_receive = DATA_CHECK;
   }
//*************************************************************************************************************************************************//
   IF(data_receive == DATA_AIR_CONDITIONING_OFF){
      state_air_conditioning_on = FALSE;
      DELAY_MS(20);
      Data_Sender(DATA_CONFIRM_AIR_CONDITIONING_OFF);
      data_receive = DATA_CHECK;
   }
}
//*************************************************************************************************************************************************//
