...
#DEFINE DATA_VALVE_DRIVER_3                                    0x43
#DEFINE DATA_VALVE_DRIVER_STATUS_0                             0x44
#DEFINE DATA_VALVE_DRIVER_STATUS_1                             0x45
#DEFINE DATA_VALVE_DRIVER_STATUS_2                             0x46
#DEFINE DATA_VALVE_DRIVER_STATUS_3                             0x47
...
#DEFINE DATA_CONFIRM_VALVE_DRIVER_3                            0x66
...
INT8 counter_temporary_2                                       = ALL_ZERO_8_BIT;
//*****************************************************************************************************************************COUNTER**VARIABLEs**//
...
//*************************************************************************************************************************************************//
            ...
            IF(!state_error_window){
               ...
               WHILE(!state_turn_complete_window){
                  ...
                  time_window_difference                          = Ticks_Difference(time_window_starting , time_window_current);
                  Turn_Left_Window();
                  IF(time_window_difference > (abs(time_window_mid - (500 * 1000)))){
                     Stop_Window();
                     Time_Delay(20);
                     state_turn_complete_window                   = TRUE;
                     counter_window_status                        = 2;
...
VOID Assign_Controller_Klape_Error_According_To_Coming_Data(){
   ...
   IF(data_receive == DATA_VALVE_DRIVER_STATUS_3){
      counter_valve_driver_status = 3;
      DELAY_MS(20);
      Data_Sender(DATA_CONFIRM_EEPROM_VALVE_DRIVER_STATUS);
      data_receive = DATA_CHECK;
